var students = [
  { name: 'Yok abi ben gelmeyim şimdi ya' },
  { name: 'Mülakata çalışmam lazım' },
  { name: 'Tasklar birikti' },
  { name: 'Haftasonu bi bok yapamadım' },
  { name: 'Şimdi gelirsem gece 2den önce dönemem' },
  { name: 'Yemiş gitmiş gibi olmayım' },
  { name: 'Boşver abi siz takılın ya' },
  { name: 'Onu başka zaman yaparız' },
  { name: 'Haklısın ama gelmicem' },
];
